...
from gym_pybullet_drones.control.MPCPIDHYControlDynamic import MPCPIDHYControlDynamic
...
def run(drone=DEFAULT_DRONES,
    ...
    if drone in [DroneModel.CF2X, DroneModel.CF2P]:
        ctrl = [MPCPIDHYControlDynamic(drone_model=drone) for _ in range(num_drones)]
